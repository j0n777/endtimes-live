...
const COLLECTORS = [
    ...
    { name: 'INTERNET_BLACKOUT', cache_duration_seconds: 1800 },
    { name: 'CYBER_ATTACKS', cache_duration_seconds: 300 },
    { name: 'SOLAR_ALERTS', cache_duration_seconds: 1800 },
    { name: 'AVIATION_MILITARY', cache_duration_seconds: 300 },
    { name: 'FLIGHT_RADAR', cache_duration_seconds: 300 },
    { name: 'WEATHER_NWS', cache_duration_seconds: 900 },
    { name: 'EMBASSY_ALERTS', cache_duration_seconds: 3600 },
    { name: 'ACLED', cache_duration_seconds: 86400 },
    { name: 'NASA_FIRMS', cache_duration_seconds: 3600 },
    { name: 'NEWS_API_AI', cache_duration_seconds: 900 },
    { name: 'ASKNEWS', cache_duration_seconds: 900 },
    { name: 'YOUTUBE_LIVE_CAMS', cache_duration_seconds: 900 },
    { name: 'TWITTER_OSINT', cache_duration_seconds: 300 },
